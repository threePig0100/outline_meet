...
const Video = lazy(() => import("~/scenes/Video"));
const Room = lazy(() => import("~/scenes/Room"));
      ...
      <AuthenticatedLayout>
        ...
        >
          <Switch>
            ...
            <Route exact path={`${videoPath()}/:term?`} component={Video} />
            <Route exact path={`${roomPath()}/:term?`} component={Room} />
